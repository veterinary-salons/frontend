            ...
            <main className={style.main}>
                <section className={style.promo}>
                    ...
                    <p className={style.promo__text}>
                        Purrfect care - сервис подбора специалистов для ухода, присмотра, лечения и воспитания ваших питомцев
                    </p>
                ...
                <section className={style.facts}>
                    <h2 className={style.facts__title}>Наша статистика поможет вам не переживать за своих любимцев</h2>
                    ...
                    <ul className={style.facts__table}>
                        <li className={style.facts__cell}>
                            ...
                            <p className={style.facts__text}>кошка вернулась с передержки в отличном настроении</p>
                        </li>

                        <li className={style.facts__cell}>
                            <h3 className={style.facts__heading}>28</h3>
                            <p className={style.facts__text}>кроликов и 1 хорёк остались довольны приёмом у ветеринара</p>
                        </li>

                        <li className={style.facts__cell}>
                            <h3 className={style.facts__heading}>70</h3>
                            <p className={style.facts__text}>щенков сдали экзамен ОКД и теперь ведут себя лучше хоязев</p>
                        </li>

                        <li className={style.facts__cell}>
                            <h3 className={style.facts__heading}>52</h3>
                            <p className={style.facts__text}>собаки порадовали своих хозяев шелковистой шерстью после груминга</p>
                        </li>
                    </ul>
                    </div>
                </section>
